            ...
            children: [
                  ...
                  children: List.generate(
                    ...
                    (index) => Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: index == 0
                                  ? AppsColor.primaryColor.withOpacity(0.8)
                                  : Colors.white),
                          boxShadow: [
                            BoxShadow(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    appText.title(
                        text: 'Nama Alarm', color: AppsColor.primaryColor),
                    TextFormField(
                      style: appText.styles(),
                      decoration: InputDecoration(
                          hintText: 'Input nama alarm',
                          hintStyle: appText.styles(
                              color: Colors.black38, weigth: FontWeight.normal),
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      flex: 1,
                      child: appText.title(
                          text: 'Mode Getar', color: AppsColor.primaryColor),
                    ),
                    CupertinoSwitch(
                      value: true,
                      onChanged: (value) {},
